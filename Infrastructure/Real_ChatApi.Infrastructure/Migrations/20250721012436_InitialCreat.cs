    ...
    public partial class InitialCreat : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupJoins", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupJoins_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupJoins_Users_ApproverUserId",
                        column: x => x.ApproverUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GroupJoins_Users_RequesterUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupJoins_ApproverUserId",
                table: "GroupJoins",
                column: "ApproverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupJoins_GroupId",
                table: "GroupJoins",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupJoins_RequesterUserId",
                table: "GroupJoins",
